...
def replace_loki_at_leaf(t, lokis_replacement):
    ...
    if(is_leaf(t) and label(t) == 'loki'):
        ...
        for branch in branches(t):
            ...
            #print("DEBUG: branch", branches(t))
            #branch = replace_loki_at_leaf(branch, lokis_replacement)
            #print("DEBUG: branch", branches(t))
...
def div_interval(x, y):
    ...
    reciprocal of y."""
    "*** YOUR CODE HERE ***"
    assert 0 not in [upper_bound(y), lower_bound(y)]
...
def check_par():
    ...
    True
    """
    r1 = interval(114, 514)  # Replace this line!
    r2 = interval(810, 1919)  # Replace this line!
    return r1, r2
